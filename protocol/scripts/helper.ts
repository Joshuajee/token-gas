...
export async function createTransferPermit(owner: Address, to: Address, value: String, nonce: String, maxFee: String, domain: IDomain) {

    const permit = { to, amount: value, nonce, maxFee }
